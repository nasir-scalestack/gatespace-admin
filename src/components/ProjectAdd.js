...
const getSteps = () => ['Project', 'Gates', 'Confirm', 'Terms', 'Done'];
                      ...
                      <Paper className={classes.paper}>
                        <div>
                          <div style={{ marginBottom: 32 }}>
                            ...
                            <Typography variant="body1" gutterBottom>
                              Select the gates you would like to receive
                              real-time proximity data
                            </Typography>
                          </div>
                          <div>
                            <Zones />
                      ...
                      <Paper className={classes.paper}>
                        <Grid item container xs={12}>
                          <Grid item xs={12}>
                            ...
                            <Typography variant="body1" gutterBottom>
                              We have successfully created a new project for you
                      ...
                      <Paper className={classes.paper}>
                        <Grid item container xs={12}>
                          <Grid item xs={12}>
                            ...
                            <Typography variant="body1" gutterBottom>
                              Your project is ready for use please download the
                              SDK for the platforms you need using the links
                              below
                            </Typography>
